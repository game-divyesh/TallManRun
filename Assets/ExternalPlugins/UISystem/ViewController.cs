...
namespace UISystem
{
    public class ViewController : MonoBehaviour
    {
        ...
        public ScreenName backButtonScreenName = ScreenName.None;
        ...
        {
            if (currentView != null && currentView != screens[GetScreenIndex(screen)].screen)
            {
        ...
        public void ChangeScreen(ScreenName screen, bool isForceUpdate = false)
        {
            if (currentView != null && isForceUpdate)
            {
                previousView = currentView;
                previousView.Hide();
                currentView = screens[GetScreenIndex(screen)].screen;
        ...
        //         CanvasUtility.ShowPopups(currentView, PopupName.ExitPopup);
