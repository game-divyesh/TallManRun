...
public class CameraController : MonoBehaviour
{
    ...
    [HideInInspector]
    public Vector3 _playersLastPosition;
    ...
    private void LateUpdate()
    {
        ...
        moveToPosition = new Vector3(moveToPosition.x + _toMoveDistanceInX, moveToPosition.y + _toMoveDistanceInY, moveToPosition.z + _toMoveDistanceInZ);
